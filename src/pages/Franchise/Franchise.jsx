    ...
    <div className="Franchise">
      ...
      <div className="franchise-field">
          ...
          <div className="franchise-field-group">
            ...
            <label>Pre-established or custom location in Delhi?</label>
...
<select
      ...
      >
        ...
        <option value="Pre-established">Pre-established</option>
        <option value="own-location">Own Location</option>
      </select>

      {formData.locationtype === 'Pre-established' && (
...
<div className="franchise-field-select">
  ...
  >
    ...
    <option value="50 L to 1 CR">50 L to 1 CR</option>
    <option value="1CR to 2 CR">1CR to 2 CR</option>
